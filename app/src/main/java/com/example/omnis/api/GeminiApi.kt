    ...
    suspend fun talkWithB9(prompt: String, reportText: String): String {
        ...
        when {
            ...
            lowerPrompt.contains("kevin") -> {
                ...
                analysis.append("- Actionable Recommendation: Maintain rigid chain of custody controls. Copy and securely share the Digital Seal signature with prosecuting authorities for file verification.")
            }
        }
